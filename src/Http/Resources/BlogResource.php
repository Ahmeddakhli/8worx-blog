...
class BlogResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'start_date' => $this->start_date ? $this->start_date->timezone(auth()->user() ? auth()->user()->timezone : 'Africa/Cairo')->toDateString() : null,
            'end_date' => $this->end_date  ? $this->end_date->timezone(auth()->user() ? auth()->user()->timezone : 'Africa/Cairo')->toDateString() : null,
            'title' => $this->title,
